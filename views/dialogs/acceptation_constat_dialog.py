# views/dialogs/acceptation_constat_dialog.py
import os
...
class AcceptationConstatDialog(ctk.CTkToplevel):
    def __init__(self, master, remboursement_controller, id_demande):
        ...
        ctk.CTkLabel(self, text="Commentaire (Obligatoire):", font=ctk.CTkFont(weight="bold")).pack(pady=(15, 2))
    ...
    def _submit(self):
        ...
        # Note : le contrôleur attend `chemin_pj_trop_percu_source` comme nom de paramètre
