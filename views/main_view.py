...
from views.help_view import HelpView  # Nouvelle importation
...
class MainView(ctk.CTkFrame):
    ...
    def creer_widgets_barre_superieure_et_titre(self):
        ...
        # Bouton Aide déplacé ici pour être à côté de Déconnexion
        bouton_aide = ctk.CTkButton(top_bar, text="Aide", command=self._ouvrir_fenetre_aide, width=70)
        bouton_aide.pack(side="right", padx=(0, 5))  # padx à droite du bouton Aide
